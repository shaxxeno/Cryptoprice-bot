...
@router.message(Command(commands=['p']))
...
@router.message(Command(commands=['listings']))
...
@router.message(Command(commands='gainers'))
...
@router.message(Command(commands='losers'))
async def gainers_losers(message: Message):
